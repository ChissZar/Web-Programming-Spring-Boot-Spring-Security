...
public class AuthController {
    ...
    public String register(@Valid @ModelAttribute RegisterDTO dto,
        ...
        try {
            ...
            redirect.addFlashAttribute("success", "OTP đã được gửi đến email (hoặc xem tại console).");
    ...
    public String forgot(@Valid @ModelAttribute ForgotPasswordDTO dto,
        ...
        try {
            ...
            redirect.addFlashAttribute("success", "OTP đã được gửi (hoặc xem tại console).");
